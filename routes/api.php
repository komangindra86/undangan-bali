...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/moments/{invitation}/report', [ModerationController::class, 'reportMoment'])->middleware('throttle:10,1');
    Route::post('/moments/{invitation}/comments/{comment}/report', [ModerationController::class, 'reportComment'])->middleware('throttle:10,1');
    Route::get('/blocked-users', [ModerationController::class, 'blockedUsers']);
    Route::post('/users/{user}/block', [ModerationController::class, 'block'])->middleware('throttle:20,1');
